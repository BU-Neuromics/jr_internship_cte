...
```
inclusions (continuous/categorical)
```{r}
col_continuous <- c("footyrs", "AFE", "totyrs", "npavas", "npwmr", "npbraak", "npneur", "npadnc", "npdiff", "npamy", "nparter", "agedeath", "agecogsx", "cogdecage", "mincogage", "AT8sulcusLog", "disdur", "AT8crest", "DLFC.WS.AT8..cell.mm2")

col_categorical <- c("cod", "DementiaHx", "npold", "npoldd", "nppath", "nplbod", "npftdtau", "npoftd", "PathAD", "PathLBD", "PathFTD", "PathMND", "PathPrion", "CTE", "CTEStage", "micsuptemp", "suicide", "Group_de", "apoe_de", "TMEM106B_dom", "TMEM106B_invrec")

col_exclude <- c("SampleName", "RIN", "Core_ID", "race", "nphemo", "npold1", "npold2", "npold3", "npold4", "npoldd1", "npoldd2", "npoldd3", "npoldd4", "nppath6", "nppick", "npftdt2", "npcort", "npprog", "npftdt5", "npftdt8", "npftdt9", "npftdt10", "npftdtdp", "micdorfront", "micinfpar", "micalc", "locratio", "subratio", "CA1ratio", "CA23ratio", "CA4ratio", "sport", "Group", "rs1990622", "rs3173615", "apoe", "AT8sulcus")

```
programmatic attempt, continuous
```{r}
...
```
programmatic attempt, categorical
```{r}

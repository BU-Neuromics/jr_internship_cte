...
design_form_ARTB <- formula(paste("~ agedeath + RIN + AT8_total + Batch"))
design_form_ARTY <- formula(paste("~ agedeath + RIN + AT8_total + Year"))
#design_form_ARTBY <- formula(paste("~ agedeath + RIN + AT8_total + Batch + Year"))
...
dds_ART <- DESeq(dds_ART)
dds_ARTB <- DESeq(dds_ARTB)
dds_ARTY <- DESeq(dds_ARTY)
#dds_ARTBY <- DESeq(dds_ARTBY)
dds_ARTB_2018 <- DESeq(dds_ARTB_2018)
dds_ARTB_2021 <- DESeq(dds_ARTB_2021)
dds_ARTB_group_high <- DESeq(dds_ARTB_group_high)
dds_ARTB_group_low <- DESeq(dds_ARTB_group_low)
dds_ARTB_group_high_2018 <- DESeq(dds_ARTB_group_high_2018)
dds_ARTB_group_high_2021 <- DESeq(dds_ARTB_group_high_2021)
dds_ARTB_group_low_2018 <- DESeq(dds_ARTB_group_low_2018)
dds_ARTB_group_low_2021 <- DESeq(dds_ARTB_group_low_2021)


saveRDS(dds_ART, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ART_model.rds")
saveRDS(dds_ARTB, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_model.rds")
saveRDS(dds_ARTY, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTY_model.rds")
#saveRDS(dds_ARTBY, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTBY_model.rds")
saveRDS(dds_ARTB_2018, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_2018_model.rds")
saveRDS(dds_ARTB_2021, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_2021_model.rds")

saveRDS(dds_ARTB_group_high, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_group_high_model.rds")
saveRDS(dds_ARTB_group_low, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_group_low_model.rds")
saveRDS(dds_ARTB_group_high_2018, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_group_high_2018_model.rds")
saveRDS(dds_ARTB_group_high_2021, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_group_high_2021_model.rds")
saveRDS(dds_ARTB_group_low_2018, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_group_low_2018_model.rds")
saveRDS(dds_ARTB_group_low_2021, "/restricted/projectnb/cteseq/jrose/results/cte_deseq_output_ARTB_group_low_2021_model.rds")

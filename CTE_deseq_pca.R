...
vst_ARTY <- vst(dds_ARTY, blind = FALSE)
...
vst_centered <- sapply(t_vst_values, function(x) scale(x, scale=FALSE))
pca_result <- prcomp(vst_centered, center = FALSE, scale = TRUE)
...
#potential outliers using BF591 code

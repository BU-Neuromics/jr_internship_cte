...
run_deseq <- mclapply(
  ...
  function(col_name) {
    ...
    design_form <- formula(paste("~ agedeath + RIN + AT8_total + Year + Batch +", col_name))
...
saveRDS(run_deseq, "/restricted/projectnb/cteseq/jrose/cte_deseq_output_ARTBY_model.rds")

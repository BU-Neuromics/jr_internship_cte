...
run_deseq <- mclapply(
  col_combined,
  function(col_name) {
    function_meta <- merged_meta[!is.na(merged_meta$Year) & merged_meta$Year == 2018, ]
...
saveRDS(run_deseq, "/restricted/projectnb/cteseq/jrose/cte_deseq_output_ARTB_2018_model.rds")

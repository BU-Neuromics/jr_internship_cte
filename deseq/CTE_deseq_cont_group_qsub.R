...
run_deseq <- mclapply(
  ...
  function(col_name) {
    ...
    function_meta <- merged_meta[!is.na(merged_meta$Group_de) & merged_meta$Group_de == "low", ]
...
saveRDS(run_deseq, "/restricted/projectnb/cteseq/jrose/cte_deseq_output_cont_low.rds")
